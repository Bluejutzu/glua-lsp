...
<CardGroup cols={2}>
  ...
  <Card title="Unknown globals" icon="circle-question">
    ...
    [framework you have not pointed at](/glua/configuration/frameworks) rather than a
    typo.
  </Card>

  <Card title="Hot paths" icon="gauge-high">
    ...
    finds by reading one file. See [hot paths](/glua/features/hot-paths).
  </Card>

  <Card title="Never called" icon="ghost">
...
If you have pointed at a [framework's source](/glua/configuration/frameworks), its
