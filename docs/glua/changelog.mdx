...
glua-gmod and [glua-cli](/glua/cli-changelog) version and release independently — this page only covers glua-gmod.

<Update label="0.6.1 (latest)" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/glua-gmod@0.6.1">View release on GitHub ↗</a>}>
**Patch Changes**
...
<Update label="0.6.0" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/glua-gmod@0.6.0">View release on GitHub ↗</a>}>
**Minor Changes**

- e38b80a: The extension and CLI now release independently — a change to one no longer bumps the other's version or changelog.
</Update>

<Update label="0.5.6" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.6">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.5.5" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.5">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.5.4" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.4">View release on GitHub ↗</a>}>
**Changed**
...
<Update label="0.5.3" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.3">View release on GitHub ↗</a>}>
**Changed**
...
<Update label="0.5.2" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.2">View release on GitHub ↗</a>}>
**Changed**
...
<Update label="0.5.1" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.1">View release on GitHub ↗</a>}>
_Nothing yet._
</Update>

<Update label="0.5.0" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.5.0">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.4.2" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/glua-gmod@0.4.2">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.4.1" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/glua-gmod@0.4.1">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.4.0" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.4.0">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.3.0" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.3.0">View release on GitHub ↗</a>}>
**Fixed**
...
<Update label="0.1.0" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/glua-gmod@0.1.0">View release on GitHub ↗</a>}>
First release.
