...
Every `net.Start`, `net.Receive`, and `util.AddNetworkString` call in your workspace is checked against its counterpart, so registration errors, orphaned handlers, and mismatched payloads show up before you test in-game.
