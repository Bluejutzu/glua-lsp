...
[Inline suppressions](/configuration/suppressions) sit outside this chain. They do not change a rule's severity; they hide individual findings from a rule that is otherwise still running.
