...
<Update label="0.4.2" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.4.2">View release on GitHub ↗</a>}>
**Added**
...
<Update label="0.4.1" description={<a href="https://github.com/Bluejutzu/glua-lsp/releases/tag/v0.4.1">View release on GitHub ↗</a>}>
**Added**
