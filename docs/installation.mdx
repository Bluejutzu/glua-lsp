...
<CardGroup cols={3}>
  ...
  <Card title="Open VSX" icon="box" href="https://open-vsx.org/extension/bluejutzu/glua-lsp">
    For **Cursor**, VSCodium, Gitpod and Theia.
  </Card>

  <Card title="VS Code Marketplace" icon="microsoft" href="https://marketplace.visualstudio.com/items?itemName=bluejutzu.glua-lsp">
    For **VS Code**.
  </Card>
</CardGroup>
