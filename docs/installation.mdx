...
Pick whichever matches your editor. All three carry the same build.

<CardGroup cols={3}>
  <Card
    title="GitHub Releases"
    icon="github"
    href="https://github.com/Bluejutzu/glua-lsp/releases/latest"
  >
  ...
  <Card
    title="Open VSX"
    icon="box"
    href="https://open-vsx.org/extension/bluejutzu/glua-lsp"
  >
  ...
  <Card
    ...
    icon="microsoft"
    href="https://marketplace.visualstudio.com/items?itemName=bluejutzu.glua-lsp"
  >
    For **VS Code**.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Install it">
    ...
    ```bash Cursor
    cursor --install-extension glua-lsp-<version>.vsix
    ```
...
<Steps>
  ...
  <Step title="Run or install">
    ...
    ```bash
    code --install-extension packages/glua-lsp/glua-lsp-<version>.vsix
    ```
  </Step>
</Steps>
