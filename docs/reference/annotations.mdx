...
GLua uses the same annotation dialect as the Lua Language Server. If you already annotate Lua projects with `---@param`, `---@class`, and similar tags, those annotations work here without changes. This page lists every supported tag and the type syntax you can use with it.
